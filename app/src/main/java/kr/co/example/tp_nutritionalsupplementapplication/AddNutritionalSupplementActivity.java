...
public class AddNutritionalSupplementActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_nutrition_supplement);
        ...
        ImageButton closeBtn = findViewById(R.id.nutritionCloseBtn);                // 영양제 추가 창 닫기 버튼
        Button medicineSaveBtn = findViewById(R.id.nutritionSaveBtn);               // 영양제 정보 저장 버튼
        ...
        medicineSaveBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(AddNutritionalSupplementActivity.this, "약 정보가 저장되었습니다.", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(AddNutritionalSupplementActivity.this, MainActivity.class);
